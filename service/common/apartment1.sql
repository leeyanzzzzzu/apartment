...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='收藏表';
...
CREATE TABLE IF NOT EXISTS `bs_comment` (
  ...
  PRIMARY KEY (`cid`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='评论表';
...
CREATE TABLE IF NOT EXISTS `bs_homeresources` (
  ...
  `housename` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT '房名称',
  `address` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT '地址',
  `size` int(11) NOT NULL COMMENT '面积',
  `price` int(11) NOT NULL COMMENT '价格',
  `imgurl` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '图片地址',
  `status` int(11) NOT NULL COMMENT '状态0：待审核，1：审核通过待发布，2：审核不通过3：已发布，4：已下架',
  `create_at` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='房源表';
...
CREATE TABLE IF NOT EXISTS `bs_order` (
  ...
  `uid` int(11) NOT NULL,
  `orderNo` varchar(50) COLLATE utf8_unicode_ci NOT NULL COMMENT '订单号',
  `homeid` int(11) NOT NULL COMMENT '房源id',
  ...
  PRIMARY KEY (`oid`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='订单表';
